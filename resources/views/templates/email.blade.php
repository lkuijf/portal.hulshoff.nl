      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>Ons familiebedrijf draait om meer dan winst. Passie, deskundigheid en ervaring, dat zijn onze pijlers.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Galwin 1 1046 AW Amsterdam</span></li>
					                <li><span class="text">0900 345 6666</span></a></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                      	<h3 class="heading">Handig</h3>
                      	<ul>
                            <li><a href="https://portal.hulshoff.nl">Home</a></li>
                            <li><a href="https://portal.hulshoff.nl/account">Account</a></li>
                            <li><a href="https://portal.hulshoff.nl/products">Producten</a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
        ...
        <tr>
          <td class="bg_white" style="text-align: center;">
          	<p>Stadsdistributie | Circulair Meubilair | Slim verhuizen | Het verhuisportaal | Voorraadbeheer</p>
          </td>
        </tr>
      </table>
