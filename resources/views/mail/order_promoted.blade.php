...
@section('content')
    <h1>{{ __('Reservation converted') }}</h1>
    <p>{{ __('Your reservation has been converted to an order') }}. {{ __('The products you selected will be delivered on the date you specified') }}. {{ __('Below you will find details of your order') }}.</p>
